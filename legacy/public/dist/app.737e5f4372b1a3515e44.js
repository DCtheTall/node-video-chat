 ...
 */
function render() {
  _reactDom2.default.hydrate(_react2.default.createElement(_app2.default, null), document.getElementById('entry-point'));
}
...
var App = function (_React$PureComponent) {
  ...
  _createClass(App, [{
    ...
    value: function handleClick() {
      ...
      this.setState({ toggleBool: !this.state.toggleBool }, function () {
        return console.log(_this2.state.toggleBool);
      });
    }
    /**
     * render
